...
const UpdateMovie = () => {
    ...
    return (
        <div className='my-10'>
            <div className='card-body bg-base-100 drop-shadow-lg max-w-5xl mx-auto'>
                <h2 className='text-xl md:text-2xl text-center'>UPDATE MOVIE</h2>
                <form className="card-body" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-control">
                        ...
                        <input type='url' className="input input-bordered rounded-none" placeholder='Enter Poster URL' defaultValue={poster} {...register("poster", { required: true })} />
                    ...
                    <div className="form-control">
                        ...
                        <input type='text' className="input input-bordered rounded-none" placeholder='Enter Title of Movie' defaultValue={title} {...register("title", { required: true, minLength: 2 })} />
                    ...
                    <div className="form-control">
                        ...
                        <select className="select select-bordered rounded-none" defaultValue={genre} {...register("genre", { required: true })}>
                    ...
                    <div className="form-control">
                        ...
                        <input className='input input-bordered rounded-none' placeholder='157' type="number" defaultValue={duration} {...register("duration", { required: true, min: 60 })} />
                    ...
                    <div className="form-control">
                        ...
                        <select className='select select-bordered rounded-none' defaultValue={year} {...register("year", { required: true })}>
                    ...
                    <div className="form-control">
                        ...
                        <textarea className='textarea textarea-bordered rounded-none' defaultValue={summary}  {...register("summary", { required: true, minLength: 10 })} />
